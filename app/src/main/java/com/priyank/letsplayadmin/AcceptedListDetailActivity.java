...
public class AcceptedListDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.accepted_details);
        ...
        Firebase.setAndroidContext(AcceptedListDetailActivity.this);
        ...
        //Buttons
        mHome = (Button) findViewById(R.id.undo_accept);
        ...
        Glide.with(AcceptedListDetailActivity.this /* context */)
    ...
    public void onClick(View view) {
        ...
        if (view == mRemove) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper
                    (AcceptedListDetailActivity.this, R.style.AlertDialogCustom));
